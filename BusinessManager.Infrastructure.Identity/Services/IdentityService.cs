...
using BusinessManager.Infrastructure.Identity.Extensions;
...
namespace BusinessManager.Infrastructure.Identity.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<LoginViewModel> LoginAsync(string userName, string password, string email)
        {
            ...
            throw new Exception(string.Format("Incorrect Credentials for user {0}.", user.Email));
        }
